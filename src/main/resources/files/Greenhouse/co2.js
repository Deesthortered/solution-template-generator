function makeCo2ConsumptionData() {
    ...
    var insideLight = parseInt(metadata.values_light_in);
    var outsideLight = parseInt(metadata.values_light_out);
...
function makeCo2ConcentrationData() {
    ...
    var minLevel = parseInt(metadata.ss_minCo2Concentration);
    var maxLevel = parseInt(metadata.ss_maxCo2Concentration);
